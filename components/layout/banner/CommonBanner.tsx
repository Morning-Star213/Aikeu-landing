  ...
  return (
    <section className="cmn-banner">
      ...
      <div className="thumb-left">
        <Image src={one} alt="Image" style={{height:"246px", width:"220px", borderRadius:"16px"}} priority />
      </div>
      <div className="thumb-right">
        <Image src={two} alt="Image" style={{height:"187px", width:"215px", borderRadius:"16px"}} priority />
      </div>
    </section>
  );
};
